...
test.describe("Reflow", () => {
  ...
  // this fails, because search box is not completely in viewport
  test("should have searchbox in view on smallest resolution", async ({
    page,
  }) => {
  ...
  // this fails, because home link cannot be scrolled into viewport at all
  ...
  // this fails, because there is a horizontal scrollbar
